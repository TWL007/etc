...
zstyle ':completion:*' completer _oldlist _expand _force_rehash _complete _match _approximate #_user_expand
...
[ -f ~/.bash_aliases ] && source ~/.bash_aliases && echo "aliases: $(grep -v '#' ~/.bash_aliases|awk '{print $2}'|awk -F= '{print $1}'|tr '\n' ' ')"
#}}}
