...
function! ViewInBrowser(name)
    if expand("%:e") == "php" || expand("%:e") == "html"
        exe ":update"
            let Chrome = "google-chrome-stable"                 "Chrome程序目录（可按实际更改）
            ...
            let htdocs ="/srv/http/www"                  "虚拟服务器地址或目录（可按实际更改）
...
if has("cscope")
    "设定可以 使用 quickfix 窗口来查看 cscope 结果
